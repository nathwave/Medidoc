...
// We'll use a regular View with backgroundColor instead of LinearGradient
...
export default function PatientLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    if (validEmail && validPassword) {
      ...
      try {
        ...
        // If successful, navigate to the patient home page
  ...
  const handleSendResetEmail = async () => {
    ...
    try {
      const response = await api.post('/patients/forgot-password', { email: resetEmail });
      ...
      Alert.alert(
        ...
        [
          {
            text: 'OK',
            onPress: () => router.push('/patient-reset-password')
          }
        ]
      );
    } catch (error: any) {
...
const styles = StyleSheet.create({
  ...
  checkmark: {
    color: '#3498db', // Blue color instead of green
    fontSize: 16,
  },
  errorText: {
    color: '#FF3B30',
  ...
  checkboxChecked: {
    backgroundColor: '#3498db', // Blue instead of green
    borderColor: '#3498db',
  },
  checkboxCheck: {
    color: 'white',
  ...
  forgotPasswordText: {
    color: '#ffffffff', // Blue instead of green
    fontSize: 14,
  },
  loginButton: {
